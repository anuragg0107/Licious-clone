    ...
    <div>
      <Box className="footer_section">
          ...
          <Box className="links">
            ...
            <Box className="links contact">
              ...
              <UnorderedList className="essential_list">
                ...
                <ListItem className="heading addr">
                  HAVE SECURITY CONCERN?
                </ListItem>
                <ListItem>Mail us to: security@licious.com</ListItem>
              </UnorderedList>
              <Hide below="md">
                <UnorderedList>
                  <ListItem>
        ...
        <Box className="keep_in_touch">
          <Text textTransform="uppercase" mb="10px">
            Keep In Touch
          </Text>
        ...
        <Box className="city_we_server" mt="20px">
